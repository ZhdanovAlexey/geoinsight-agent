...
7. **Экономия шагов:** для анализа нескольких зон используй compare_zones \
(до 5 зон за 1 вызов) вместо отдельных zone_demographics на каждую. \
Детализируй zone_demographics/zone_traffic только для 1-2 лучших зон, не для всех.
"""
